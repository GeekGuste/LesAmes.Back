...
namespace LesAmes.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250822234815_InitForDeploy")]
    partial class InitForDeploy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HobbySoul", b =>
                {
                    b.Property<string>("HobbiesId")
                        .HasColumnType("text");

                    b.Property<Guid>("SoulsId")
                        .HasColumnType("uuid");

                    b.HasKey("HobbiesId", "SoulsId");
            ...
            modelBuilder.Entity("HobbyTutor", b =>
                {
                    b.Property<string>("HobbiesId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("HobbiesId", "TutorsId");

                    b.HasIndex("TutorsId");

                    b.ToTable("TutorHobbies", (string)null);
                });
            ...
            modelBuilder.Entity("LesAmes.Domain.Hobbies.Hobby", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("HobbyCategoryId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LesAmes.Domain.Hobbies.HobbyCategory", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LesAmes.Domain.Souls.AgeRange", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LesAmes.Domain.Souls.ImpactFamily", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PilotContact")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HobbySoul", b =>
                {
                    b.HasOne("LesAmes.Domain.Hobbies.Hobby", null)
                        .WithMany()
                        .HasForeignKey("HobbiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LesAmes.Domain.Souls.Soul", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HobbyTutor", b =>
                {
                    ...
                    b.HasOne("LesAmes.Domain.Users.Tutor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LesAmes.Domain.Hobbies.Hobby", b =>
                {
                    b.HasOne("LesAmes.Domain.Hobbies.HobbyCategory", "HobbyCategory")
                        .WithMany("Hobbies")
            ...
            modelBuilder.Entity("LesAmes.Domain.Souls.AgeRange", b =>
                {
                    b.HasOne("LesAmes.Domain.Users.Tutor", null)
                        .WithMany("SoulsAgeRanges")
                        .HasForeignKey("TutorId");
                });

            modelBuilder.Entity("LesAmes.Domain.Souls.Soul", b =>
                {
                    b.HasOne("LesAmes.Domain.Souls.AgeRange", "AgeRange")
                        .WithMany()
